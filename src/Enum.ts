...
type FindIndex<Arr extends readonly any[], El, acc extends number[] = []> = Arr extends readonly [infer First, ...infer Rest] 
  ? El extends First ? acc['length'] : FindIndex<Rest, El, [...acc, 1]>
  : -1
